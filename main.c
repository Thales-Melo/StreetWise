/*
    ...
    ALUNO: THALES MELO DA PENHA
    ENGENHARIA DE COMPUTAÇÃO - UFES
    OBJETIVO: IMPLEMENTAR O ALGORITMO DE DIJKSTRA PARA RESOLVER O PROBLEMA DE MENOR CAMINHO EM UM GRAFO
*/

/* 
    TODOS OS TAD'S POSSUEM COMENTÁRIOS RELEVANTES PARA COMPREENSÃO DO CÓDIGO
    ALGUNS HEADERS POSSUEM OBSERVAÇÕES IMPORTANTES NO INÍCIO DO ARQUIVO
*/
